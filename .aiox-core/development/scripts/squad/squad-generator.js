...
aios:
  minVersion: "${config.aiosMinVersion || DEFAULT_AIOX_MIN_VERSION}"
  type: squad
...
- Node.js >= 18.x
- AIOX >= ${config.aiosMinVersion || DEFAULT_AIOX_MIN_VERSION}
...
class SquadGenerator {
   ...
   * @param {string} [config.aiosMinVersion] - Minimum AIOX version
  ...
  async generate(config) {
    ...
    const fullConfig = {
      ...
      aiosMinVersion: config.aiosMinVersion || DEFAULT_AIOX_MIN_VERSION,
