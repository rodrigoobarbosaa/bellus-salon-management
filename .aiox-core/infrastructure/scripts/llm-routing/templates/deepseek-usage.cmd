...
set "TRACKER_SCRIPT=%USERPROFILE%\aios-core\.aiox-core\infrastructure\scripts\llm-routing\usage-tracker\index.js"
if exist "%TRACKER_SCRIPT%" goto :found

set "TRACKER_SCRIPT=%USERPROFILE%\Workspaces\AIOX\SynkraAI\aios-core\.aiox-core\infrastructure\scripts\llm-routing\usage-tracker\index.js"
if exist "%TRACKER_SCRIPT%" goto :found
...
set "TRACKER_SCRIPT=%APPDATA%\npm\node_modules\@aios-fullstack\core\.aiox-core\infrastructure\scripts\llm-routing\usage-tracker\index.js"
if exist "%TRACKER_SCRIPT%" goto :found
...
echo   - %%USERPROFILE%%\aios-core\.aiox-core\infrastructure\scripts\llm-routing\usage-tracker\
echo.
echo Set AIOX_HOME environment variable: setx AIOX_HOME "C:\path\to\aios-core"
exit /b 1
